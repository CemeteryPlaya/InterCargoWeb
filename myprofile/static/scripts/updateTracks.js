document.addEventListener('DOMContentLoaded', function () {
    var formEl = document.getElementById('update_tracks_form');
    ...
    var deliveredView = document.getElementById('delivered_view');
    var tracksTableBody = document.getElementById('tracks_table_body');
    var addRowBtn = document.getElementById('add_row_btn');
    var formToggleContainer = document.getElementById('form_toggle_container');
    var formToggleBtn = document.getElementById('form_toggle_btn');
    var ownerBlock = document.getElementById('owner_block');
    var weightBlock = document.getElementById('weight_block');
    ...
    function toggleFormView() {
        ...
        if (isTableMode) {
            ...
            deliveredView.classList.remove('hidden');
            ...
            deliveredView.classList.add('hidden');
    ...
    function updateView() {
        ...
        if (isDelivered) {
            formToggleContainer.classList.remove('hidden');
            ...
            formToggleContainer.classList.add('hidden');
    ...
    function syncToTable() {
        ...
        var weights = weightsArea.value.split('\n').map(function (s) { return s.trim(); }).filter(function (s) { return s; });

        tracksTableBody.innerHTML = '';

        var maxRows = Math.max(codes.length, owners.length, weights.length, 1);
    ...
    function syncFromTable() {
        ...
        weightsArea.value = weights.join('\n');
    }
    ...
    formEl.addEventListener('submit', function () {
        if (statusSelect.value === 'delivered' && isTableMode) {
            syncFromTable();
        }
    });
